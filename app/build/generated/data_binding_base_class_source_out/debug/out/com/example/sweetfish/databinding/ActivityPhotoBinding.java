...
public final class ActivityPhotoBinding implements ViewBinding {
  ...
  private ActivityPhotoBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton back,
  ...
  public static ActivityPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPhotoBinding((ConstraintLayout) rootView, back, photoView);
    }
